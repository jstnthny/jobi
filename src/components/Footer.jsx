               ...
               <ul className="socialIcons">
                <li>
                    <a href="#"><svg width="10" height="18" viewBox="0 0 10 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path fillRule="evenodd" clipRule="evenodd" d="M6.45748 17.75V9.7625H9.04416L9.46667 6.2125H6.45748V4.48365C6.45748 3.56953 6.48239 2.6625 7.84492 2.6625H9.22497V0.12425C9.22497 0.0860875 8.03956 0 6.84032 0C4.33574 0 2.76749 1.47059 2.76749 4.17125V6.2125H0V9.7625H2.76749V17.75H6.45748Z" fill="black"/>
                        </svg>
                    </a>
                </li>
                <li>
